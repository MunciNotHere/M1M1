...
local win = lib:Window("M1M1: ScriptHub",Color3.fromRGB(200, 200, 200), Enum.KeyCode.RightShift)

local Info = win:Tab("Info")
local Settings = win:Tab("Settings")
local MM2 = win:Tab("MM2")
...
if setclipboard then setclipboard("https://discord.gg/QrF2H6Vhg9") end
end)

Info:Button("RightShift to close/open window", function()
--xd
end)
...
MM2:Button("yarhm", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Joystickplays/psychic-octo-invention/main/yarhm.lua", false))()
end)

MM2:Button("ESP ( cant disable )", function()
...
Fisch:Button("Auto Farm", function()
...
BladeBall:Button("test blade", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Alexisisback/Universall/refs/heads/main/Testblade.lua", true))()
end)

BladeBall:Button("Triple Hub", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/TripleScript/NothingHub/main/NothingHub"))()
end)
...
Universal:Button("Infinite yeild", function()
